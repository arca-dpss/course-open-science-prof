...
- `_targets/meta/meta` is important
]
]
---
## `targets` Workflow
...
--
- **R Markdown as Target**<br>R Markdown considered as target in the pipeline<br>https://books.ropensci.org/targets/files.html#literate-programming
